...
<section class="cykeltur">
	...
	<p>
		...
		Något man bör vara medveten om när man väljer att ta cykeln i Barcelona är att trafiken där inte är på något vis lika regelrätt och försiktig som den vi är vana vid här i Sverige.
		Man bör därför vara på sin vakt, men självklart finns både bra och framkomliga cykelleder genom hela staden. Med en karta i högsta hugg är staden lättnavigerad.
	</p>
	<img src="parcguell.jpg" alt="">
	<p>
		<strong>Parc Güell</strong> är ett populärt resemål i norra Barcelona. Parken grundlades och skapades av arkitekten Antonio Gaudí, vars verk kan skådas över hela Barcelona.
		...
		<br><br>Mer info hittar du här: <a href="http://www.parkguell.es/en/" target="_blank">Park Güell</a>
	</p>
	<img src="campnou.jpg" alt="">
	<p>
		...
		<br><br>Mer info hittar du här: <a href="http://www.fcbarcelona.com/camp-nou" target="_blank">Camp Nou</a>
	</p>
	</div>
</section>
